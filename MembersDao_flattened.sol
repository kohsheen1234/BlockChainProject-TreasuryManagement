...
abstract contract ERC20 is Context, IERC20, IERC20Metadata, IERC20Errors {
    ...
    //from :arushi to:contract. owner: contract spender: arushi etherscan : contract, arushi -> 1
    function transferFromCustom(address from, address to, uint256 value, address contractAddress) public virtual returns (bool) {
       // address spender = _msgSender();
        _spendAllowance(contractAddress, from, value);
        _transfer(from, to, value);
        return true;
    }
}
...
contract MemberToken is ERC20, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("MemberToken", "MBT")
        Ownable(initialOwner)
        ERC20Permit("MemberToken")
    {}
...
contract BankToken is ERC20, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("BankToken", "BNK")
        Ownable(initialOwner)
...
contract LandToken is ERC20, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("LandToken", "LND")
        Ownable(initialOwner)
        ERC20Permit("LandToken")
    {}
...
// File: Project/TreasuryManagement.sol
